...
def main():
    ...
    for i, d in enumerate(days):
        ...
        if level == 0:
            # No contribution: always neutral/dark, never fake-green.
            cells.append(
            ...
            # Real contribution: pulse between its true level and a brighter green.
            hot = PULSE[level]
...
<text x="635" y="181" fill="#8b949e" font-size="10">green pulse only on real contribution days</text>
</svg>'''
